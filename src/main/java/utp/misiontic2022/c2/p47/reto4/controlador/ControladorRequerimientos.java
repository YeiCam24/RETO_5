...
public class ControladorRequerimientos {
    private final Requerimiento_1Dao requerimiento_1Dao = new Requerimiento_1Dao();
    private final Requerimiento_2Dao requerimiento_2Dao = new Requerimiento_2Dao();
    private final Requerimiento_3Dao requerimiento_3Dao = new Requerimiento_3Dao();
